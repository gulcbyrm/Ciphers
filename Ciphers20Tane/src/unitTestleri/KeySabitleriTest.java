...
import ciphers.des.Key;
import ciphers.des.exceptions.KeyLengthUygunDeil;
import org.junit.Assert;
import org.junit.Test;
import ciphers.des.sabitler.KeySabitleri;
  ...
  /*  @Test
   ...
   /* @Test
    public void tabloyaGoreKaydir_CnUretimi() throws Exception {
       ...
       // System.out.println(Arrays.toString(ciphers.des.des.sabitler.CnDizisiniOlustur("1111000011001100101010101111")));
...
/*
   ...
   /* @Test
    public void keySon() throws Exception {
        String[] tmpKey=key.birlestirCnDn(key.nDizisiniOlustur("1111000011001100101010101111"), key.nDizisiniOlustur("0101010101100110011110001111"));
        final int[] pc2Tablosu = ciphers.des.des.sabitler.getPC2();
        final String[] kullanilacakKey = new String[16];
        for(int i=0;i<16;i++){
            final String siradakiKey = tmpKey[i];
            kullanilacakKey[i]=ciphers.des.des.sabitler.karistir(pc2Tablosu, siradakiKey);
        }
